                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group controlId="exampleForm.ControlTextarea1">
                            <Form.Label>Keterangan (Model, Ukuran) : </Form.Label>
                            <Form.Control as="textarea" rows={3} name="keterangan" placeholder="Note : Jika tidak dicantumkan, maka akan dipilihkan secara random" value={keterangan} onChange={(event) => changeHandler(event)} />
                        </Form.Group>
